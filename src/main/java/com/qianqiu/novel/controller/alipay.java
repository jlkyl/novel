...
public class alipay {
    ...
    @RequestMapping("pay")
    public void pay(Integer choose,Integer money,Integer bookid,Integer potential,  HttpServletRequest httpRequest, HttpServletResponse httpResponse) throws ServletException, IOException {
